      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="min-h-[calc(100vh-5rem)] flex items-center">
          <div className="max-w-xl py-12 lg:py-20">
            ...
            {/* CTA Button */}
            <button className="group bg-white hover:bg-gray-100 text-gray-900 px-6 py-3 rounded-full font-medium text-sm transition-all duration-300 flex items-center space-x-2 shadow-lg hover:shadow-xl">
