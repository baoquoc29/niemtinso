      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="flex justify-center items-center mb-6 md:block md:text-center relative">
            ...
            <button className="bg-white hover:bg-gray-50 text-[#3000d9] px-4 py-2 md:px-6 md:py-2.5 rounded-full font-medium text-xs md:text-base transition-all duration-300 border border-white shadow-sm hover:shadow-md inline-flex items-center gap-2 btn-animate md:absolute md:top-0 md:right-0 flex-shrink-0">
