...
export default function ActivityDetailPage() {
  ...
  const featuredArticles = t.activitiesPage.events.articles;
            ...
            <div className="w-full lg:w-[70%] min-h-[400px] flex flex-col order-2 lg:order-1">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-2">
                <nav className="flex items-center gap-2 text-base md:text-lg font-semibold text-gray-700 flex-wrap">
                  ...
                  <span className="mx-1 text-gray-400">&gt;</span>
                  <Link to="/activities?tab=events" className="hover:underline text-blue-600">{breadcrumb.events}</Link>
                </nav>
              ...
              <article className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-8">
                ...
                <div
                  className="text-gray-700 leading-relaxed text-base md:text-lg prose prose-lg max-w-none article-body"
